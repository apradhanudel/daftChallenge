...
pgm.add_node("bacteria_food", "Bacteria in\nfood"+r" $(Y)$", 3, 3, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': 'thistle', 
                 'edgecolor': 'purple', 
                 'linewidth': 2,
...
# Example of a professionally styled node
pgm.add_node("vitamin_c", "Vitamin C\nIntake" + r" $(X)$", 1, 5, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': 'gold',   # changed from 'lightgreen' to something distinct from scurvy
                 'edgecolor': 'orange',
                 'linewidth': 2,
                 'alpha': 0.8,
             })
pgm.add_node("collagen_synthesis", "Collagen Synthesis\n" + r" $(Y)$", 3, 3, aspect = 4, scale = 1.1,
             plot_params={
